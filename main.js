//base by Manul Official (Manu Bot Inc.)
...
require('./Manul_Official_WA_Bot_V4.js')
nocache('../Manul_Official_WA_Bot_V4.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
require('./main.js')
