...
break
await XeonBotInc.sendMessage(m.chat, thumbnailMessage, { quoted: m });
          await XeonBotInc.sendMessage(m.chat, { audio: finalAudioBuffer, mimetype: 'audio/mpeg' }, { quoted: m });
          await doReact("✅");
        } catch (err) {
...
`,
  ...
  break
  await XeonBotInc.sendMessage(m.chat, thumbnailMessage, { quoted: m });
          await XeonBotInc.sendMessage(m.chat, { document: finalAudioBuffer, mimetype: 'audio/mpeg', fileName: `${videoInfo.title}.mp3` }, { quoted: m });
          await doReact("✅");
        } catch (err) {
          console.error('Error sending audio:', err);
          m.reply('Error sending audio.');
...
`,
          ...
          await XeonBotInc.sendMessage(m.chat, thumbnailMessage, { quoted: m });
          await XeonBotInc.sendMessage(m.chat, { document: finalAudioBuffer, mimetype: 'audio/mpeg', fileName: `${firstVideo.title}.mp3` }, { quoted: m });
          await doReact("✅");
        } catch (err) {
          console.error('Error sending audio:', err);
          m.reply('Error sending audio.');
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"Telegram 💧\",\"url\":\"https://t.me/Manul Official\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
                 "name": "cta_url",
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"WhatsApp ☘️\",\"url\":\"https://chat.whatsapp.com/EIjQV4nxXwJ6S6QHSa9jpN\",\"merchant_url\":\"https://www.google.com\"}"
              },              
              {
  "name": "quick_reply",
